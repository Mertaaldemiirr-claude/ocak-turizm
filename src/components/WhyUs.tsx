...
const features = [
  {
    ...
    title: "Helal Konaklama",
    description: "Alkolsuz otel secenekleri, aile dostu tesisler ve helal mutfak garantisi ile gonul rahatligiyla konaklama.",
  },
  {
    icon: (
    ...
    title: "Namaz Duzeni",
    description: "Tur programlari namaz vakitlerine gore planlanir. Yakindaki camilere ulasim her zaman saglanir.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
    ),
    title: "TURSAB Guvenli",
    description: "TURSAB belgeli, sigorta kapsamli organizasyonlar. Ailece huzurlu ve guvenli seyahatler.",
  },
  {
    icon: (
    ...
    description: "Yuzlerce ailenin tercihi. Islami hassasiyetlere saygili, samimi ve profesyonel bir ekip.",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 text-sm">
            Islami degerlere uygun, aile dostu tur organizasyonu
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="bg-gray-50 rounded-2xl p-6 text-center hover:-translate-y-1 hover:shadow-md transition-all duration-200"
            >
