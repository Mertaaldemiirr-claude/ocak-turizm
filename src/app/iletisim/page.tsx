          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm mb-8 leading-relaxed">
                Turlarimiz hakkinda bilgi almak, ozel tur talebi olusturmak veya
                herhangi bir sorunuz icin bize ulasabilirsiniz.
              </p>

              <div className="space-y-5 mb-8">
                {[
                  { icon: HiPhone, label: "Telefon", value: phone, href: `tel:${phone.replace(/\s/g, "")}` },
                  { icon: HiMail, label: "E-posta", value: email, href: `mailto:${email}` },
                  { icon: HiLocationMarker, label: "Adres", value: address },
                  { icon: HiClock, label: "Calisma Saatleri", value: "Pazartesi - Cuma: 09:00 - 18:00" },
                ].map((item) => (
