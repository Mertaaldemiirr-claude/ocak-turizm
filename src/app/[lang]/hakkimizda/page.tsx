  ...
  const valuesData = [
    {
      ...
      title: dict.aboutPage.v1Title,
      description: dict.aboutPage.v1Desc,
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
      ),
      title: dict.aboutPage.v2Title,
      description: dict.aboutPage.v2Desc,
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
      ),
      title: dict.aboutPage.v3Title,
      description: dict.aboutPage.v3Desc,
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" /></svg>
      ),
      title: dict.aboutPage.v4Title,
      description: dict.aboutPage.v4Desc,
    },
  ];

  const reasons = [
    { title: dict.aboutPage.r1Title, text: dict.aboutPage.r1Desc },
    { title: dict.aboutPage.r2Title, text: dict.aboutPage.r2Desc },
    { title: dict.aboutPage.r3Title, text: dict.aboutPage.r3Desc },
    { title: dict.aboutPage.r4Title, text: dict.aboutPage.r4Desc },
    { title: dict.aboutPage.r5Title, text: dict.aboutPage.r5Desc },
  ];

  const stats = [
    { number: "500+", label: dict.aboutPage.happyTravelers },
    { number: "50+", label: dict.aboutPage.toursOrganized },
    { number: "4", label: dict.aboutPage.destinationCount },
    { number: "5.0", label: dict.aboutPage.avgRating },
  ];
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
              <div className="bg-gray-50 rounded-2xl p-8">
                <h3 className="font-heading font-bold text-primary text-lg mb-3">{dict.aboutPage.mission}</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  {dict.aboutPage.missionDesc}
                </p>
              </div>
              <div className="bg-gray-50 rounded-2xl p-8">
                <h3 className="font-heading font-bold text-primary text-lg mb-3">{dict.aboutPage.vision}</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
