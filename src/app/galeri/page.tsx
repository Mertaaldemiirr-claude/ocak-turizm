        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          {images.length === 0 ? (
            <div className="text-center py-20">
              ...
              <p className="text-gray-400 text-sm">Henuz galeri gorseli bulunmuyor.</p>
              <p className="text-gray-300 text-xs mt-1">Yakinda turlarimizdan harika kareler eklenecek.</p>
            </div>
          ) : (
